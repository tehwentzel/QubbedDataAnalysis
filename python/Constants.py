class Const():
    ...
    mdasi_surgery_alone = [int (x) for x in [
        '689',
        '298',
        '620',
        '621',
...
#     mdasi_surgery_alone = [int(x) for x in mdasi_surgery_alone]
#     mdasi_surgery = [int(x) for x in mdasi_surgery]
